...
<ul class="nav">
	...
	<li class="divider-vertical"></li>
	<li class="active"><a href="center.jsp">活动中心</a></li>
	<li class="divider-vertical"></li>
...
<ul class="nav nav-tabs">
	<li class="active"><a href="#center" data-toggle="tab">活动中心</a></li>
</ul>
...
<img src="image/gym/huodongzhongxin/841361preview4.jpg" alt="">
</div>
<div class="item">
<img src="image/gym/huodongzhongxin/2012410102630182.jpg" alt="">
</div>
<div class="item">
<img src="image/gym/huodongzhongxin/20120417094019302.jpg" alt="">
</div>
<div class="item">
...
<div class="span8">
<img src="image/6.jpg" class="pull-right" width="400">
</div>
<div class="span10">
